$(document).ready(function() {
	...
	const addSubNav = (menuItem) => {
		...
		if (hasChildren) {
			...
			path.setAttribute('d', 'M18.99,21.02L.42,2.45C-.14,1.89-.14.99.41.43c0,0,0,0,0,0,.56-.56,1.46-.56,2.02,0,0,0,0,0,0,0l17.55,17.57L37.55.42c.56-.56,1.47-.56,2.03,0s.56,1.47,0,2.03l-18.56,18.56c-.56.56-1.46.56-2.02,0,0,0,0,0,0,0Z');
